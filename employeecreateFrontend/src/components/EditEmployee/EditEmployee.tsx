...
const EditEmployee = () => {
  ...
  // const selectedEmployee = employeesList.filter((emp) => emp.id === Number(id));
  // console.log("allEmployees in edit", employeesList);
  // console.log("selectedEmployee in edit", selectedEmployee);
  ...
  //   await patchEmployeeByID(employeeSelected.id || "", data).then((response: Employee) => {
